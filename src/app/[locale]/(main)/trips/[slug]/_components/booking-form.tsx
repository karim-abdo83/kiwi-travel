    ...
    <Card className="w-full max-w-sm mx-auto bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
      <CardContent className="space-y-0 p-0">
        ...
        <SignInButton>
          ...
          <Link href="https://wa.me/905352699881" target="_blank" className="w-full bg-green-500 hover:bg-green-600 text-white font-medium py-4 px-6 rounded-full flex items-center justify-center gap-3 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105">
