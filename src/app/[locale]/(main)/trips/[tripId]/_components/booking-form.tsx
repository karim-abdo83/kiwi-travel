      ...
      <CardContent className="space-y-0 p-0">
        ...
        <div className="px-6 py-2 space-y-2 border-t border-gray-50 ">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="font-semibold text-gray-900 ">Safe Payment</h3>
            <p className="text-sm text-gray-500">Simple, convenient and reliable!</p>
          </div>
          <hr />
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="font-semibold text-gray-900 ">Official Partner</h3>
            <p className="text-sm text-gray-500">Approved ticket supplier!</p>
          </div>
          <hr />
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="font-semibold text-gray-900 ">Trusted Help Center</h3>
            <p className="text-sm text-gray-500">Authorized customer support!</p>
          </div>
        </div>

        <div className="text-center text-sm text-gray-500 px-6 pb-6">
          <p>{t("noCharge")}</p>
        </div>
      </CardContent>
    </Card>
